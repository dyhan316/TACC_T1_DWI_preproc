...
#sub_save_dir=/scratch/08834/tg881334/CHA_preproc_try/3.qsipreproc_results
sub_save_dir=/scratch/08834/tg881334/CHA_preproc/3.qsipreproc_results
...
singularity run --cleanenv -B ${data_pth}/:/data:ro,${sub_save_dir}/:/out,${supp_dir}:/freesurfer ${sing_img_dir} /data /out participant -w /out/tmp --output_resolution 1.2 --denoise_after_combining --unringing_method mrdegibbs --b0_to_t1w_transform Affine --intramodal_template_transform SyN --do_reconall --fs-license-file /freesurfer/license.txt --skip_bids_validation
