...
SUBJECTS_DIR=/storage/bigdata/WECANDOIT/4.fs_recon_all_v2  #default freesurfer env variable을 새로 지정해 주는 것! 
save_dir=/storage/bigdata/WECANDOIT/4_1.fs_stats_v2
#list=`cat $1`
...
ls -d ${SUBJECTS_DIR}/sub-* > sublist_for_fs_stats.txt #-d so that not iterative

list=`cat sublist_for_fs_stats.txt`
