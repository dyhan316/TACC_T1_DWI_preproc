...
#SBATCH -o /scratch/connectome/dyhan316/CHA_preprocessing/time_it/cpu_8_1/output_%J.out #%J : job id 가 들어가는 것
#SBATCH -e /scratch/connectome/dyhan316/CHA_preprocessing/time_it/cpu_8_1/error_%J.error
#SBATCH --ntasks=1
